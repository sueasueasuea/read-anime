...
INSERT INTO "new_Comic" ("coverUrl", "createdAt", "description", "id", "published", "title", "updatedAt", "userId") SELECT "coverUrl", "createdAt", "description", "id", "published", "title", "updatedAt", "userId" FROM "Comic";
DROP TABLE "Comic";
