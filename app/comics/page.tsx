...
const comicList = [
  ...
  },
  {
    ...
    description:
      "In a post-apocalyptic world, the last survivor tries to preserve the light of civilization.",
    chapters: 105,
  ...
  },
  {
    ...
    description:
      "In a city sealed under a dome, a young man begins to question the world outside.",
    chapters: 120,
  ...
  },
  {
    ...
    description:
      "A genius inventor discovers a time loop tied to his own death.",
    chapters: 101,
  ...
  },
  {
    ...
    description:
      "A boy with dormant dark power must choose between light and darkness.",
    chapters: 98,
  ...
  },
  {
    ...
    title: "Ice Crown",
    description:
      "A northern princess embarks on a journey to reclaim her stolen throne.",
    chapters: 85,
  ...
  },
  {
    ...
    description:
      "A forbidden love story in the desert and the fight for freedom.",
    chapters: 90,
        ...
        <div className={`${styles.list}`}>
          {comics.map((comic) => (
            <ContentCard
              ...
              author={comic.author.displayName}
              key={comic.id}
              id={comic.id}
              title={comic.title}
            />
